...
public class MenuBar extends JMenuBar {
    ...
    public MenuBar(Frame owner, CefBrowser browser, ControlPanel control_pane, DownloadDialog downloadDialog, CefCookieManager cookieManager) {
        ...
        openFileDialog.addActionListener(e -> {
            CefRunFileDialogCallback callback = new CefRunFileDialogCallback() {
                @Override
                public void onFileDialogDismissed(CefBrowser cefBrowser, Vector<String> filePaths) {
        ...
        httpRequest.addActionListener(e -> {
            ...
            if (searchFor != null && !searchFor.isEmpty()) {
                ...
                myRequest.setURL("http://www.baidu.com/s?wd=" + searchFor);
                myRequest.setFirstPartyForCookies("http://www.baidu.com/s?wd=" + searchFor);
    ...
    public void
    addBookmark(String name, String URL) {
