...
/**
 * @author ：sunchao
 * @date ：Created in 2019/12/25 11:24 @description： Annotation Demo
 */
@Bad(scope = "class", list = {@Parameter(name = "AnnotationDemo")})
class AnnotationDemo {
    @Bad(scope = "field", list = {@Parameter(name = "annotation"), @Parameter(name = "get")})
